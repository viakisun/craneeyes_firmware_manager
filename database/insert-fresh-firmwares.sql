-- Complete reset and rebuild - Insert new firmwares
...
((SELECT id FROM models WHERE name = 'SS3506M'), '1.0.0', '2025-01-15', '2.97 KB', 0, 'firmwares/SS3506M/1.0.0/SS3506M-firmware-v1.0.0.txt', 'Initial firmware release for SS3506M'),
...
((SELECT id FROM models WHERE name = 'SS75065'), '1.0.0', '2025-01-15', '2.97 KB', 0, 'firmwares/SS75065/1.0.0/SS75065-firmware-v1.0.0.txt', 'Initial firmware release for SS75065'),
